  ...
  return (
    <div className={styles.nav}>
      <div className={styles.container} style={{ display: "flex" }}>
        <Link to="/">
          <div className={styles.heading}>twitter</div>
      ...
      {signedIn != null ? (
        <div className={styles.right}>
          <div>
            <Link to={`/profile/${signedIn.username}`}>
              {signedIn.profilePicture ? (
                <img className={styles.profile} src={signedIn.profilePicture} />
              ) : (
                <img className={styles.profile} src={Noprofile} />
              )}
            </Link>
          </div>
          <div
            ...
            <Link to="/register">
              ...
              >
                ...
                <g id="SVGRepo_iconCarrier">
                  ...
                  <path
                    id="primary"
                    d="M9,21H20a1,1,0,0,0,1-1,5,5,0,0,0-5-5H11"
                    style={{
                      fill: "none",
                      stroke: " #000000",
                      strokeLinecap: "round",
